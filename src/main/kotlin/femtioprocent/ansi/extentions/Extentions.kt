...
fun Boolean.ansiColor() = if (this) Color.bold(Color.LegacyColor.G, "T") else Color.bold(Color.LegacyColor.R, "f")
fun String.ansiColor(cc: Color.LegacyColor) = Color.bold(cc, this)
fun String.ansiBgColor(cc: Color.LegacyColor) = Color.normal(cc, this)
